...
export class generateTables1668045133188 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "PaymentMethods" (
        ...
        CONSTRAINT "PK_0981b742c60ac062ed17718cca0" PRIMARY KEY ("id")
      )`
    );
    await queryRunner.query(
      `CREATE TABLE "Users" (
        ...
        "paymentMethodsId" uuid, CONSTRAINT 
        "REL_9393640c776c8917f188b42a8d" UNIQUE ("paymentMethodsId"), 
    ...
    await queryRunner.query(
      `CREATE TABLE "watch_later" (
        "id" uuid NOT NULL DEFAULT uuid_generate_v4(), 
        "userId" uuid, "moviesId" uuid, 
        "seriesId" uuid, 
        CONSTRAINT "REL_f971d015c35cf30740e90e183e" UNIQUE ("userId"), 
        CONSTRAINT "PK_6b5e31210dfa78b187b51c5f1e0" PRIMARY KEY ("id")
      )`
    );
    await queryRunner.query(
      `CREATE TABLE "Series" (
    ...
    await queryRunner.query(
      `ALTER TABLE
        "Episodes" 
      ADD CONSTRAINT
        "FK_0adffc8f08ac5e4255017f418ab" 
      FOREIGN KEY
        ("seriesId") 
      REFERENCES
        "Series"("id") 
    ...
    await queryRunner.query(
      `ALTER TABLE
        "Users" 
      ADD CONSTRAINT
        "FK_9393640c776c8917f188b42a8d3" 
      FOREIGN KEY
        ("paymentMethodsId") 
      REFERENCES
        "PaymentMethods"("id") 
    ...
    await queryRunner.query(
      `ALTER TABLE
        "watch_later" 
      ADD CONSTRAINT
        "FK_f971d015c35cf30740e90e183eb" 
      FOREIGN KEY
        ("userId") 
      REFERENCES
        "Users"("id") 
    ...
    await queryRunner.query(
      `ALTER TABLE 
        "watch_later" 
      ADD CONSTRAINT 
        "FK_fd9456126275e22d8a6216a4774" 
      FOREIGN KEY 
        ("moviesId") 
      REFERENCES 
        "Movies"("id") 
    ...
    await queryRunner.query(
      `ALTER TABLE 
        "watch_later" 
      ADD CONSTRAINT 
        "FK_cde692e8eb73549bc11abe6cf1a" 
      FOREIGN KEY 
        ("seriesId") 
      REFERENCES 
        "Series"("id") 
    ...
    await queryRunner.query(
      `ALTER TABLE 
        "History" 
      ADD CONSTRAINT 
        "FK_5ea3bfa8b735c0fd8ddbd8742c8" 
      FOREIGN KEY 
        ("userId") 
      REFERENCES 
        "Users"("id") 
    ...
    await queryRunner.query(
      `ALTER TABLE 
        "Ratings" 
      ADD CONSTRAINT 
        "FK_397b08b1bc71e05771316bbda07" 
      FOREIGN KEY 
        ("userId") 
      REFERENCES 
        "Users"("id")
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Ratings" DROP CONSTRAINT "FK_397b08b1bc71e05771316bbda07"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "History" DROP CONSTRAINT "FK_5ea3bfa8b735c0fd8ddbd8742c8"`
    );
    await queryRunner.query(
      `ALTER TABLE "watch_later" DROP CONSTRAINT "FK_cde692e8eb73549bc11abe6cf1a"`
    );
    await queryRunner.query(
      `ALTER TABLE "watch_later" DROP CONSTRAINT "FK_fd9456126275e22d8a6216a4774"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Episodes" DROP CONSTRAINT "FK_0adffc8f08ac5e4255017f418ab"`
    );
