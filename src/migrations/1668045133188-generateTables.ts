...
export class generateTables1668045133188 implements MigrationInterface {
    name = 'generateTables1668045133188'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Episodes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "season" integer NOT NULL, "episode" integer NOT NULL, "name" character varying NOT NULL, "duration" integer NOT NULL, "description" character varying NOT NULL, "seriesId" uuid, CONSTRAINT "PK_c8a4205985bcb1a630ca98f7ca3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "isAdm" boolean NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "paymentMethodsId" uuid, CONSTRAINT "REL_9393640c776c8917f188b42a8d" UNIQUE ("paymentMethodsId"), CONSTRAINT "PK_16d4f7d636df336db11d87413e3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Series" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "year" character varying(4) NOT NULL, "description" character varying NOT NULL, "isActive" boolean NOT NULL, "direction" character varying NOT NULL, CONSTRAINT "PK_c2b16b9595c21f34d4f31067d10" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "History" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "watchedAt" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean NOT NULL, "userId" uuid, "seriesId" uuid, "movieId" uuid, CONSTRAINT "PK_ba2fff4418f12dffa3d21157008" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Movies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "year" character varying(4) NOT NULL, "isActive" boolean NOT NULL, "duration" integer NOT NULL, "description" character varying NOT NULL, "direction" character varying NOT NULL, CONSTRAINT "PK_3c3d780a38fe84af75495a4099f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "History" ADD CONSTRAINT "FK_5ea3bfa8b735c0fd8ddbd8742c8" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "History" DROP CONSTRAINT "FK_5ea3bfa8b735c0fd8ddbd8742c8"`);
