...
export class createtables1667493799543 implements MigrationInterface {
    name = 'createtables1667493799543'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Series" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "year" TIMESTAMP NOT NULL, "isActive" boolean NOT NULL, "description" character varying NOT NULL, "direction" character varying NOT NULL, CONSTRAINT "PK_c2b16b9595c21f34d4f31067d10" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "Movies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "year" TIMESTAMP NOT NULL, "duration" integer NOT NULL, "isActive" boolean NOT NULL, "description" character varying NOT NULL, "direction" character varying NOT NULL, CONSTRAINT "PK_3c3d780a38fe84af75495a4099f" PRIMARY KEY ("id"))`);
