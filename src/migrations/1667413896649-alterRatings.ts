...
export class alterRatings1667413896649 implements MigrationInterface {
  name = 'alterRatings1667413896649';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Users" (
        ...
        "paymentMethodsId" uuid, 
        CONSTRAINT "REL_9393640c776c8917f188b42a8d" UNIQUE ("paymentMethodsId"), 
    ...
    await queryRunner.query(
      `ALTER TABLE
        "Episodes" 
      ADD CONSTRAINT 
        "FK_491fe41b8e82503d0e37d7c96db" 
      FOREIGN KEY 
        ("serieId") 
      REFERENCES 
        "Series"("id") 
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Episodes" DROP CONSTRAINT "FK_491fe41b8e82503d0e37d7c96db"`
    );
